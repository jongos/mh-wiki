...
**Cash multiple / MOIC** - Total cash receipts divided by invested capital. It measures magnitude but ignores timing. See [[wiki/concepts/financier-return-economics|Return Economics]].
...
**Perfection** - The legal step making a security interest effective against relevant third parties, which may require filing, possession, control, recordation or local-law action depending on the asset. See [[wiki/concepts/security-package|Security Package]].
...
**Tax-credit receivable** - Expected value arising from a production incentive program. It remains conditional on program, claimant, spend, filing, audit and realization requirements until paid or monetized. See [[wiki/concepts/tax-credit-collateral|Tax-Credit Collateral]].
