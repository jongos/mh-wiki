...
# Tax-Credit Receivables as Collateral
...
- program and claimant eligibility analysis;
- qualified-spend model tied to budget, payroll and vendor evidence;
- local-counsel analysis of assignment, setoff and perfection;
- lockbox, payment direction, claimant ownership or transfer documentation as applicable;
- audit, filing, certificate and buyer-settlement milestones;
- controlled application of realized proceeds to the waterfall.
...
- Raw source: [[raw/sources/MediaHedge_Tax_Credit_Receivables_as_Collateral_Financier_Brief.docx]]
- Hash: `B65D82D4412620142278B9EE455C86BB3D5AEEF313A65DAF5D7711F5A1027154`
